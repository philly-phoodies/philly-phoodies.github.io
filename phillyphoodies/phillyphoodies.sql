...
CREATE TABLE TypeFood (FoodTypeID varchar(30) not null AUTO_INCREMENT, FoodType varchar(30) not null, primary key(FoodTypeID));

CREATE TABLE Food (FoodID varchar(20) not null AUTO_INCREMENT, FoodName varchar(30) not null, FoodPrice float not null, primary key(FoodID));
...
INSERT INTO `phillyphoodies`.`users` (`UserName`, `UserPassword`, `Email`, `Location`) VALUES ('THH29', 'THH29', 'thh29@drexel.edu', 'Philadelphia');
INSERT INTO `phillyphoodies`.`users` (`UserName`, `UserPassword`, `Email`, `Location`) VALUES ('MRD336', 'MRD336', 'MRD36@DREXEL.EDU', 'PHILADELPHIA');
INSERT INTO `phillyphoodies`.`users` (`UserName`, `UserPassword`, `Email`, `Location`) VALUES ('JF945', 'JF945', 'JF945@DREXEL.EDU', 'PHILADELPHIA');
INSERT INTO `phillyphoodies`.`users` (`UserName`, `UserPassword`, `Email`, `Location`) VALUES ('KMR711', 'KMR711', 'KMR711@DREXEL.EDU', 'PHILADELPHIA');
